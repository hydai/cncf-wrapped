...
const zh: Dict = {
  ...
  nfJoinItems: [
    ...
    { href: 'https://ocgroups.dev/cncf', label: 'CNCF Community Groups', desc: '找在地聚會（KCD、meetup），見見真人' },
  ],
...
const en: Dict = {
  ...
  nfJoinItems: [
    ...
    { href: 'https://ocgroups.dev/cncf', label: 'CNCF Community Groups', desc: 'find a local meetup or KCD near you' },
  ],
